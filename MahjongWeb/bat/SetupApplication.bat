...
:: Android packaging
set AND_CERT_NAME="MultiScreenFeathers"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MultiScreenFeathers.p12
...
set IOS_PROVISION=cert\MultiScreenFeathers.mobileprovision
...
set APP_ID=air.MultiScreenFeathers

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MultiScreenFeathers
